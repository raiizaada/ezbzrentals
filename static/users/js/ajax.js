...
function call_ajax_page(page) {
	...
	{
		document.title = "Dashboard | Ezbz - Admin & Dashboard Template";
	}
	else
	{
		var title = page.replace(".html", "");
		var title1 = title.replace("-", " ");
		document.title = title1.charAt(0).toUpperCase() + title1.slice(1) + " | Ezbz - Admin & Dashboard Template";
	}
